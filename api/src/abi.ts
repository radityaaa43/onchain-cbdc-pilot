...
export const ABI: Record<string, JsonFragment> = {
  ...
  approveFor:   { name: "approveFor",   type: "function", inputs: [{ name: "owner", type: "address" }, { name: "spender", type: "address" }, { name: "amount", type: "uint256" }], outputs: [], stateMutability: "nonpayable" },
  ...
  registerBondV3: { name: "registerBondV3", type: "function", inputs: [{ name: "bond", type: "address" }, { name: "maturityDate", type: "uint256" }], outputs: [], stateMutability: "nonpayable" },
  getLastBondId:  { name: "getLastBondId",  type: "function", inputs: [], outputs: [{ type: "bytes32" }], stateMutability: "view" },
  getLastBondIdV3: { name: "getLastBondIdV3", type: "function", inputs: [], outputs: [{ type: "bytes32" }], stateMutability: "view" },
  ...
  checkTransferAllowed:     { name: "checkTransferAllowed",     type: "function", inputs: [{ name: "from", type: "address" }, { name: "to", type: "address" }, { name: "amount", type: "uint256" }, { name: "assetId", type: "bytes32" }], outputs: [{ name: "", type: "bool" }, { name: "", type: "string" }], stateMutability: "view" },
  ...
  bondStaticData:          { name: "bondStaticData",          type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "isin", type: "string" }, { name: "issuerLei", type: "string" }, { name: "issuerName", type: "string" }, { name: "issuanceType", type: "string" }, { name: "currency", type: "string" }, { name: "paymentCurrency", type: "string" }, { name: "settlementCurrency", type: "string" }, { name: "denomination", type: "uint256" }, { name: "integralMultiples", type: "uint256" }, { name: "calculationAmount", type: "uint256" }, { name: "pricingDate", type: "string" }, { name: "issuanceDate", type: "string" }, { name: "settlementDate", type: "string" }, { name: "issuePrice", type: "uint256" }, { name: "methodOfDistribution", type: "string" }, { name: "governingLaw", type: "string" }, { name: "formOfNote", type: "string" }, { name: "statusOfNote", type: "string" }, { name: "aggregateNominalAmount", type: "uint256" }, { name: "maturityDate", type: "string" }, { name: "dltBondIndicator", type: "bool" }, { name: "listingMarket", type: "string" }, { name: "listingMarketType", type: "string" }, { name: "clearingSettlementSystem", type: "string" }, { name: "sellingRestrictions", type: "string" }, { name: "manufacturerTargetMarket", type: "string" }, { name: "flagNegativePledge", type: "bool" }, { name: "flagGrossUp", type: "bool" }, { name: "flagCrossDefault", type: "bool" }] }], stateMutability: "view" },
  bondTerms:               { name: "bondTerms",               type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "interestType", type: "string" }, { name: "interestRateBps", type: "uint256" }, { name: "paymentFrequency", type: "string" }, { name: "dayCountFraction", type: "string" }, { name: "businessDayConvention", type: "string" }, { name: "businessDayCenter", type: "string" }, { name: "interestPaymentDay", type: "uint8" }, { name: "interestPaymentMonth", type: "uint8" }, { name: "firstPaymentDate", type: "string" }, { name: "lastPaymentDate", type: "string" }, { name: "interestCommencementDate", type: "string" }, { name: "finalRedemptionPct", type: "uint256" }, { name: "earlyRedemptionPct", type: "uint256" }] }], stateMutability: "view" },
  dltPlatformData:         { name: "dltPlatformData",         type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "platformType", type: "string" }, { name: "accessibility", type: "string" }, { name: "role", type: "string" }, { name: "operatorName", type: "string" }, { name: "platformName", type: "string" }, { name: "tokenType", type: "string" }, { name: "smartContract", type: "string" }] }], stateMutability: "view" },
  creditEvents:            { name: "creditEvents",            type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "flagDefault", type: "bool" }, { name: "flagRedeemed", type: "bool" }, { name: "rating", type: "string" }, { name: "ratingAgency", type: "string" }] }], stateMutability: "view" },
  bondRatings:             { name: "bondRatings",             type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "ratingAgency", type: "string" }, { name: "expectedProductRating", type: "string" }, { name: "partyRating", type: "string" }] }], stateMutability: "view" },
  indonesianMarketData:    { name: "indonesianMarketData",    type: "function", inputs: [], outputs: [{ name: "", type: "tuple", components: [{ name: "productCode", type: "string" }, { name: "seriesCode", type: "string" }, { name: "regulatoryFramework", type: "string" }, { name: "shariaComplianceBoard", type: "string" }, { name: "underlyingAsset", type: "string" }, { name: "tenorDays", type: "uint256" }, { name: "auctionMechanism", type: "string" }] }], stateMutability: "view" },
  setBondStaticData:       { name: "setBondStaticData",       type: "function", inputs: [{ name: "data", type: "tuple", components: [{ name: "isin", type: "string" }, { name: "issuerLei", type: "string" }, { name: "issuerName", type: "string" }, { name: "issuanceType", type: "string" }, { name: "currency", type: "string" }, { name: "paymentCurrency", type: "string" }, { name: "settlementCurrency", type: "string" }, { name: "denomination", type: "uint256" }, { name: "integralMultiples", type: "uint256" }, { name: "calculationAmount", type: "uint256" }, { name: "pricingDate", type: "string" }, { name: "issuanceDate", type: "string" }, { name: "settlementDate", type: "string" }, { name: "issuePrice", type: "uint256" }, { name: "methodOfDistribution", type: "string" }, { name: "governingLaw", type: "string" }, { name: "formOfNote", type: "string" }, { name: "statusOfNote", type: "string" }, { name: "aggregateNominalAmount", type: "uint256" }, { name: "maturityDate", type: "string" }, { name: "dltBondIndicator", type: "bool" }, { name: "listingMarket", type: "string" }, { name: "listingMarketType", type: "string" }, { name: "clearingSettlementSystem", type: "string" }, { name: "sellingRestrictions", type: "string" }, { name: "manufacturerTargetMarket", type: "string" }, { name: "flagNegativePledge", type: "bool" }, { name: "flagGrossUp", type: "bool" }, { name: "flagCrossDefault", type: "bool" }] }], outputs: [], stateMutability: "nonpayable" },
  setBondTerms:            { name: "setBondTerms",            type: "function", inputs: [{ name: "data", type: "tuple", components: [{ name: "interestType", type: "string" }, { name: "interestRateBps", type: "uint256" }, { name: "paymentFrequency", type: "string" }, { name: "dayCountFraction", type: "string" }, { name: "businessDayConvention", type: "string" }, { name: "businessDayCenter", type: "string" }, { name: "interestPaymentDay", type: "uint8" }, { name: "interestPaymentMonth", type: "uint8" }, { name: "firstPaymentDate", type: "string" }, { name: "lastPaymentDate", type: "string" }, { name: "interestCommencementDate", type: "string" }, { name: "finalRedemptionPct", type: "uint256" }, { name: "earlyRedemptionPct", type: "uint256" }] }], outputs: [], stateMutability: "nonpayable" },
  setDltPlatformData:      { name: "setDltPlatformData",      type: "function", inputs: [{ name: "data", type: "tuple", components: [{ name: "platformType", type: "string" }, { name: "accessibility", type: "string" }, { name: "role", type: "string" }, { name: "operatorName", type: "string" }, { name: "platformName", type: "string" }, { name: "tokenType", type: "string" }, { name: "smartContract", type: "string" }] }], outputs: [], stateMutability: "nonpayable" },
  setCreditEvents:         { name: "setCreditEvents",         type: "function", inputs: [{ name: "events", type: "tuple", components: [{ name: "flagDefault", type: "bool" }, { name: "flagRedeemed", type: "bool" }, { name: "rating", type: "string" }, { name: "ratingAgency", type: "string" }] }], outputs: [], stateMutability: "nonpayable" },
  setBondRatings:          { name: "setBondRatings",          type: "function", inputs: [{ name: "ratings", type: "tuple", components: [{ name: "ratingAgency", type: "string" }, { name: "expectedProductRating", type: "string" }, { name: "partyRating", type: "string" }] }], outputs: [], stateMutability: "nonpayable" },
  setIndonesianMarketData: { name: "setIndonesianMarketData", type: "function", inputs: [{ name: "data", type: "tuple", components: [{ name: "productCode", type: "string" }, { name: "seriesCode", type: "string" }, { name: "regulatoryFramework", type: "string" }, { name: "shariaComplianceBoard", type: "string" }, { name: "underlyingAsset", type: "string" }, { name: "tenorDays", type: "uint256" }, { name: "auctionMechanism", type: "string" }] }], outputs: [], stateMutability: "nonpayable" },
